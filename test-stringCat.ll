...
@strptr = private unnamed_addr constant [4 x i8] c"hi \00"
...
entry:
  ...
  %s2 = alloca i8*
  %s3 = alloca i8*
  store i8* getelementptr inbounds ([4 x i8], [4 x i8]* @strptr, i32 0, i32 0), i8** %s1
  %str_of_int = call i8* (i64, ...) @str_of_int(i64 1)
  store i8* %str_of_int, i8** %s2
  %s21 = load i8*, i8** %s2
  %s12 = load i8*, i8** %s1
  %str_con = call i8* (i8*, i8*, ...) @str_con(i8* %s12, i8* %s21)
  store i8* %str_con, i8** %s3
  %s33 = load i8*, i8** %s3
  %printf = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt.47, i32 0, i32 0), i8* %s33)
  ret i64 0
}
