...
@strptr = private unnamed_addr constant [9 x i8] c"test.jpg\00"
@strptr.48 = private unnamed_addr constant [4 x i8] c"png\00"
@strptr.49 = private unnamed_addr constant [4 x i8] c"out\00"
...
entry:
  ...
  %m1 = load i64*, i64** %m
  %write_img = call i64 (i64*, i8*, i8*, ...) @write_img(i64* %m1, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @strptr.49, i32 0, i32 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @strptr.48, i32 0, i32 0))
  store i64 %write_img, i64* %i
  %i2 = load i64, i64* %i
  %printf = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @fmt.46, i32 0, i32 0), i64 %i2)
  ret i64 0
}
