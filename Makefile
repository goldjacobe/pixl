...
#TARFILES = ast.ml codegen.ml Makefile _tags pixl.ml parser.mly README \
        scanner.mll semant.ml testall.sh arcade-font.pbm font2c \
	$(TESTFILES:%=tests/%)

#pixl-llvm.tar.gz : $(TARFILES)
#	cd .. && tar czf pixl-llvm/pixl-llvm.tar.gz \
		$(TARFILES:%=pixl-llvm/%)
